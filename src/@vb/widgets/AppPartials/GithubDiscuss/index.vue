      ...
      <div className="card card-skip flex-grow-1">
        ...
        <div className="card-body">
          ...
          <ol>
            ...
            <li>
              Use <code>Run Cell</code> command from hydrogen on the code below
              with about 50 extra new lines
            </li>
          </ol>
          <pre>
          ...
          <p>
            <strong>Actual behavior:</strong> Scroll top of the result view has
            been set to 0 upon removal and adding back to the active DOM
          </p>
