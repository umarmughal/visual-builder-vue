    ...
    <ul class="list-unstyled">
      <li :class="$style.item">
        ...
        <div :class="$style.itemPicContainer">
          ...
          <i
            ...
            class="text-success fe fe-file-text"
          />
        </div>
        <div>
          <div>
      ...
      <li :class="$style.item">
        ...
        <div :class="$style.itemPicContainer">
          ...
          <i
            :class="$style.itemIcon"
            class="text-primary fe fe-database"
          />
        </div>
        <div>
          <div>
